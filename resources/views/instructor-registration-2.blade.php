...
<body style=" font-family: 'Noto Sans Arabic', sans-serif;" class=" text-gray-900 antialiased">
    @include('navcourses')
        <div class=" pt-[85px] container mx-auto px-4 ">
               ...
               <form method="POST" action="{{ route('instructor.store2') }}" enctype="multipart/form-data" >
                 @csrf
                 ...
                 <div class="flex gap-20 mb-20">
                  <div class="flex-1">
                     ...
                     <!-- Email Address -->
                     <div class="mt-4">
                                      <x-input-label for="email" :value="__('البريد الإكتروني')" />
                 ...
                 <div class="flex-1">
                    ...
                    <!-- Cv_path -->
                     ...
                     <div class="pt-[55px] flex justify-end ">
